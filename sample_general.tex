...
\reportdate{\today}
\authornames{
    \teammember{San}{Zhang}{sanz0@illinois.edu}\\[1em]
    \teammember{Si}{Li}{sil0@illinois.edu}\\[1em]
    \teammember{Dawu}{Wang}{dawu@example.com}\\[1em]
    \teammember{English}{Member}{englishm0@illinois.edu}
}
